  ...
  return (
    ...
    >
      <h2 className="mb-4 text-[11px] font-semibold text-[var(--text-secondary)] uppercase tracking-widest">
        {t("systemLearningMemory")}
      </h2>

      <div className="card-terminal overflow-hidden space-y-3 p-4">
        <div className="flex items-center gap-2 mb-1">
          <Brain className="w-4 h-4 text-[var(--purple)]" />
          <span className="text-[12px] font-semibold text-[var(--text-primary)]">{t("aiSystemMemory")}</span>
        </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-2">
                  <div>
                    <div className="flex items-center gap-1.5 mb-1">
                      ...
                      <span className="text-[10px] text-[var(--text-secondary)]/60">{t("whatHappened")}</span>
                    </div>
                  ...
                  <div>
                    <div className="flex items-center gap-1.5 mb-1">
                      ...
                      <span className="text-[10px] text-[var(--text-secondary)]/60">{t("whatMissed")}</span>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 border-t border-[var(--border-custom)]/50">
                  <div>
                    <div className="flex items-center gap-1.5 mb-1">
                      ...
                      <span className="text-[10px] text-[var(--text-secondary)]/60">{t("systemAdjustmentLabel")}</span>
                    </div>
                  ...
                  <div>
                    <div className="flex items-center gap-1.5 mb-1">
                      ...
                      <span className="text-[10px] text-[var(--text-secondary)]/60">{t("futureImpact")}</span>
                    </div>
            ...
            {data.map((memory, i) => (
              ...
              >
                <div className="text-[10px] text-[var(--text-secondary)]/50 mb-1 font-mono">
                  {t("learningRecord", { num: i + 1 })}
                </div>
                <div className="space-y-2">
                  <p className="text-[12px] text-[var(--text-primary)]">
                    <span className="text-[var(--amber)]/80 font-medium">{t("eventLabel")}：</span>
                    {stripAllMarkdown(memory.whatHappened)}
                  </p>
                  <p className="text-[12px] text-[var(--text-secondary)]">
                    <span className="text-[var(--red)]/80">{t("missedLabel")}：</span>
                    {stripAllMarkdown(memory.whatAgentsMissed)}
                  </p>
                  <p className="text-[12px] text-[var(--blue)]/80">
                    <span className="font-medium">{t("adjustmentLabel")}：</span>
