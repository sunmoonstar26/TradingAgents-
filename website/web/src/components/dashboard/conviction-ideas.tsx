              ...
              <div className="p-3 rounded-lg bg-[var(--panel2)]/80 border border-[var(--border-custom)]">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[10px] text-[var(--text-secondary)]/60 mb-0.5">核心驱动</p>
            ...
            <div className="px-4 pb-3">
              <div className="p-2.5 rounded-lg bg-[var(--red)]/5 border border-[var(--red)]/10">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[10px] text-[var(--red)]/60 mb-0.5">主要风险</p>
        ...
        {editing && (
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="card-terminal !p-5 flex flex-col items-center justify-center gap-3 border-dashed border-[var(--blue)]/20 min-h-[200px] relative">
            <div className="relative w-full">
              <input type="text" value={addQuery} onChange={(e) => handleAddSearch(e.target.value)} placeholder="添加股票..." className="w-full bg-[var(--panel)] border border-[var(--border-custom)] rounded-lg px-3 py-2 text-xs font-mono text-[var(--text-primary)] placeholder:text-[var(--text-secondary)]/30 focus:outline-none focus:border-[var(--blue)]/40" />
            ...
            <span className="text-[10px] font-mono text-[var(--text-secondary)]/20">搜索股票添加</span>
          ...
          <div key={item.ticker} className="card-terminal !p-0 overflow-hidden min-w-[280px] shrink-0 flex flex-col">
            ...
            <div className="px-3 pb-1.5">
              <div className="flex items-start gap-1.5 p-2 rounded bg-[var(--panel2)]/60 border border-[var(--border-custom)]">
                ...
                <div><p className="text-[10px] text-[var(--text-secondary)]/60">核心驱动</p><p className="text-[11px] text-[var(--text-primary)] font-medium line-clamp-2">{item.keyDriver}</p></div>
              </div>
            </div>
            <div className="px-3 pb-2">
              <div className="flex items-start gap-1.5 p-2 rounded bg-[var(--red)]/5 border border-[var(--red)]/10">
                ...
                <div><p className="text-[10px] text-[var(--red)]/60">主要风险</p><p className="text-[11px] text-[var(--text-secondary)] line-clamp-2">{item.primaryRisk}</p></div>
              </div>
            </div>
